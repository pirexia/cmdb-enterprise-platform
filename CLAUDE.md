...
**En develop (no liberado):** v3.4.2 (column picker en reporte Inventario, 61 cols) + v3.4.3 (column picker en la **vista** /inventory, ~55 cols)
**Rama activa:** `develop`
**PRs abiertos:** —
