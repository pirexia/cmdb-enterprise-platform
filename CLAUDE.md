...
**Versión actual en producción:** v3.4.3 — ✅ LIBERADA (tags `v3.4.2` + `v3.4.3`, PR #170 develop→main, 2 releases, despliegue limpio, 2026-07-01)
**Rama activa:** `develop`
**PRs abiertos:** —
