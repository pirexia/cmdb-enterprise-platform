...
**Versión actual en producción:** v3.5.4 — ✅ LIBERADA (tag `v3.5.4`, merge develop→main, desplegada y verificada en producción con despliegue completo del stack, 2026-07-16)
**Rama activa:** `develop`
**PRs abiertos:** —
**Issues abiertos para la siguiente sesión:** #178 (N8N_API_KEY desincronizada, 401 unauthorized en `provisionOnBoot()`), #179 (ventana de reintento de aprovisionamiento n8n del backend — 60s — insuficiente en reinicio completo del stack)
