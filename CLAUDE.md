...
**Versión actual en producción:** v3.4.4 — ✅ LIBERADA (tag `v3.4.4`, PR #171 develop→main, desplegada y verificada en producción, 2026-07-09)
**Rama activa:** `feature/v3.5.0-staff-schedule` (v3.5.0 en curso → destino `develop`, NO main)
**PRs abiertos:** —
