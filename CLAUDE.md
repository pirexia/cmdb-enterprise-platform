...
**Versión actual en producción:** v3.5.3 — ✅ LIBERADA (tag `v3.5.3`, PRs #176 feature→develop + #177 develop→main, release en GitHub, desplegada y verificada en local con despliegue limpio, 2026-07-13)
**Rama activa:** `develop`
**PRs abiertos:** —
