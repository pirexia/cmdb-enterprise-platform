...
| 🤖 **Asistente IA local con RAG** | Chat conversacional para buscar información en documentos (contratos, procedimientos, etc.) usando un modelo de lenguaje local (Ollama + pgvector). Sin transferencia de datos a servicios externos. Citaciones obligatorias en cada respuesta. Respeta los permisos de visibilidad por rol. Ver `docs/RAG_HOST_PREPARATION.md` para los requisitos del servidor. |
