...
- **T5 Docs 🔄**: ARCHITECTURE .md/.en (§13.3 → 18 tipos + bloque v3.4.4), USER_MANUAL .md/.en (§9: fila INSTALLED_IN + subsección "Instalar en chasis"), CLAUDE.md (Plan Activo + release v3.4.4 en curso), package.json → 3.4.4.
