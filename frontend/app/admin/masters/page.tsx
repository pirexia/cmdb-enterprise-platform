    ...
    <div className="flex h-screen bg-slate-100 overflow-hidden">
      ...
      <aside className="w-56 flex-shrink-0 bg-white border-r border-slate-200 flex flex-col">
        ...
        <div className="px-5 py-5 border-b border-slate-100">
          <h1 className="text-sm font-bold text-slate-900">{t('masters.title')}</h1>
          <p className="text-[11px] text-slate-400 mt-0.5">{t('masters.subtitle')}</p>
        </div>
        ...
        <div className="border-t border-slate-100 p-4">
          <button
            onClick={load}
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-medium text-slate-600 hover:bg-slate-100 transition-colors disabled:opacity-50"
          >
